            ...
            <div class="row g-3 mb-5">
                    ...
                    <div class="flip-box">
                        <div class="flip-box-inner">
                            <div class="flip-box-front">
                                <img class="image" src="addons/img/refecences-logo_AEM-01.png">
                            </div>
                ...
                <div class="col-lg-2 col-md-6 wow zoomIn" data-wow-delay="0.6s"
                    ...
                    <div class="flip-box">
                        <div class="flip-box-inner">
                            <div class="flip-box-front">
                                <img class="image" src="addons/img/refecences-logo_AMAL IRRIGATION-01.png">
                            </div>
                            <div class="flip-box-back">
                                <img class="image" src="addons/img/refecences-logo_AMAL IRRIGATION-01.png">
                ...
                <div class="col-lg-2 col-md-6 wow zoomIn" data-wow-delay="0.6s"
                    ...
                    <div class="flip-box">
                        <div class="flip-box-inner">
                            <div class="flip-box-front">
                                <img class="image" src="addons/img/refecences-logo_carrefourmanu.png">
                            </div>
                            <div class="flip-box-back">
                                <img class="image" src="addons/img/refecences-logo_carrefourmanu.png">
                ...
                <div class="col-lg-2 col-md-6 wow zoomIn" data-wow-delay="0.3s"
                    ...
                    <div class="flip-box">
                        <div class="flip-box-inner">
                            <div class="flip-box-front">
                                <img class="image" src="addons/img/refecences-logo_CMGP-01.png">
                            </div>
                            <div class="flip-box-back">
                                <img class="image" src="addons/img/refecences-logo_CMGP-01.png">
                ...
                <div class="col-lg-2 col-md-6 wow zoomIn" data-wow-delay="0.6s"
                    ...
                    <div class="flip-box">
                        <div class="flip-box-inner">
                            <div class="flip-box-front">
                                <img class="image" src="addons/img/refecences-logo_hortisud.png">
                            </div>
                            <div class="flip-box-back">
                                <img class="image" src="addons/img/refecences-logo_hortisud.png">
                ...
                <div class="col-lg-2 col-md-6 wow zoomIn" data-wow-delay="0.6s"
                    ...
                    <div class="flip-box">
                        <div class="flip-box-inner">
                            <div class="flip-box-front">
                                <img class="image" src="addons/img/refecences-logo_INTECA_Model2.png">
                            </div>
                            <div class="flip-box-back">
                                <img class="image" src="addons/img/refecences-logo_INTECA_Model2.png">
