...
<head>
    ...
    <!-- ===========  All Stylesheet ================= -->
    <!--  Icon css plugins -->
    <link rel="stylesheet" href="addons/css/icons.css">
    <!--  animate css plugins -->
    <link rel="stylesheet" href="addons/css/animate.css">
    <!--  magnific-popup css plugins -->
    <link rel="stylesheet" href="addons/css/magnific-popup.css">
    <!--  owl carosuel css plugins -->
    <link rel="stylesheet" href="addons/css/owl.carousel.min.css">
    <!-- metis menu css file -->
    <link rel="stylesheet" href="addons/css/metismenu.css">
    <!--  owl theme css plugins -->
    <link rel="stylesheet" href="addons/css/owl.theme.css">
...
<body class="body-wrapper">    
        ...
        <div class="container">
            ...
            <div class="row mt-3 mt-lg-5">
                <div class="col-xl-4 d-none d-xl-block">
                    <div class="features-banner mt-30 bg-cover" style="background-image: url('addons/img/home1/feature_img.jpg')">
                    </div>
                </div>
                <div class="col-xl-8 col-12">
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="feature-cta bg-cover bg-center text-white" style="background-image: url('addons/img/home1/wave.png')">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 pl-lg-5 col-12 order-1 order-lg-2">
                    ...
                    <div class="about-us-img" style="background-image: url('addons/img/home1/about-us.jpg')">
                    </div>
            ...
            <div class="row">
                <div class="col-md-6 col-xl-3 col-12">
                    <div class="single-service-item">
                        <div class="icon">
                            <img src="addons/img/icon/sicon1.png" alt="service">
                        </div>
                ...
                <div class="col-md-6 col-xl-3 col-12">
                    <div class="single-service-item">
                        <div class="icon">
                            <img src="addons/img/icon/sicon2.png" alt="service">
                        </div>
                ...
                <div class="col-md-6 col-xl-3 col-12">
                    <div class="single-service-item">
                        <div class="icon">
                            <img src="addons/img/icon/sicon3.png" alt="service">
                        </div>
                ...
                <div class="col-md-6 col-xl-3 col-12">
                    <div class="single-service-item">
                        <div class="icon">
                            <img src="addons/img/icon/sicon4.png" alt="service">
                        </div>
    ...
    <section class="funfact-wrapper text-white">
        <div class="container">
            <div class="funfact-content-grid bg-cover" style="background-image: url('addons/img/funfact-line.png')">
            ...
            <div class="team-members-list row">
                <div class="col-12 col-md-6 col-xl-3">
                    <div class="single-team-member">
                        <div class="member-img bg-cover bg-center" style="background-image: url('addons/img/team/team1.jpg')">
                        </div>
                ...
                <div class="col-12 col-md-6 col-xl-3">
                    <div class="single-team-member active">
                        <div class="member-img bg-cover bg-center" style="background-image: url('addons/img/team/team2.jpg')">
                        </div>
                        <div class="member-bio">
                ...
                <div class="col-12 col-md-6 col-xl-3">
                    <div class="single-team-member">
                        <div class="member-img bg-cover bg-center" style="background-image: url('addons/img/team/team3.jpg')">
                        </div>
                        <div class="member-bio">
                ...
                <div class="col-12 col-md-6 col-xl-3">
                    <div class="single-team-member">
                        <div class="member-img bg-cover bg-center" style="background-image: url('addons/img/team/team4.jpg')">
                        </div>
                        <div class="member-bio">
            ...
            <div class="row grid">
                <div class="col-xl-4 col-md-6 grid-item business product engineering">
                    <div class="single-case-study">
                        <div class="features-thumb bg-cover" style="background-image: url('addons/img/case/1.jpg')"></div>
                        <div class="content">
                ...
                <div class="col-xl-4 col-md-6 grid-item product engineering">
                    <div class="single-case-study">
                        <div class="features-thumb bg-cover" style="background-image: url('addons/img/case/2.jpg')"></div>
                        <div class="content">
                            <h3>Business Knowledge</h3>
                            <p>IT Consultation</p>
                            <a href="project-details.html">Read more <i class="fas fa-arrow-right"></i></a>
                ...
                <div class="col-xl-4 col-md-6 grid-item consulting product">
                    <div class="single-case-study">
                        <div class="features-thumb bg-cover" style="background-image: url('addons/img/case/3.jpg')"></div>
                        <div class="content">
                ...
                <div class="col-xl-4 col-md-6 grid-item business engineering">
                    <div class="single-case-study">
                        <div class="features-thumb bg-cover" style="background-image: url('addons/img/case/4.jpg')"></div>
                        <div class="content">
                ...
                <div class="col-xl-4 col-md-6 grid-item consulting business">
                    <div class="single-case-study">
                        <div class="features-thumb bg-cover" style="background-image: url('addons/img/case/5.jpg')"></div>
                        <div class="content">
                ...
                <div class="col-xl-4 col-md-6 grid-item consulting product">
                    <div class="single-case-study">
                        <div class="features-thumb bg-cover" style="background-image: url('addons/img/case/6.jpg')"></div>
                        <div class="content">
                            <h3>Business Knowledge</h3>
                            <p>IT Consultation</p>
                            <a href="project-details.html">Read more <i class="fas fa-arrow-right"></i></a>
        ...
        <div class="container">
            <div class="brand-carousel-active pt-60 pb-60 d-flex justify-content-between owl-carousel">
                <div class="single-client">
                    <img src="addons/img/brand/1.png" alt="">
                </div>
                <div class="single-client">
                    <img src="addons/img/brand/2.png" alt="">
                </div>
                <div class="single-client">
                    <img src="addons/img/brand/3.png" alt="">
                </div>
                <div class="single-client">
                    <img src="addons/img/brand/4.png" alt="">
                </div>
                <div class="single-client">
                    <img src="addons/img/brand/b4.png" alt="">
                </div>
            </div>
        </div>
    </div>
    ...
    <section class="testimonial-wrapper section-padding">
        <div class="testimonial-bg bg-cover" style="background-image: url('addons/img/testi_bg.jpg')"></div>
        <div class="container">
            <div class="row">
                    ...
                    <div class="testimonial-carousel-active owl-carousel owl-theme">
                        <div class="single-testimonial">
                            ...
                            <div class="client-info">
                                <div class="client-img bg-cover" style="background-image: url('addons/img/home1/testi1.jpg')"></div>
    ...
    <section class="blog-section section-padding bg-contain" style="background-image: url('addons/img/blog_bg.png')">
        <div class="container">
            <div class="row mb-30">
                <div class="col-12 col-lg-12">
                    <div class="section-title text-center">
            ...
            <div class="row">
                <div class="col-xl-4 col-md-6 col-12">
                    <div class="single-blog-card">
                        <div class="blog-featured-thumb bg-cover" style="background-image: url('addons/img/blog1.jpg')"></div>
                        <div class="content">
                ...
                <div class="col-xl-4 col-md-6 col-12">
                    <div class="single-blog-card active">
                        <div class="blog-featured-thumb bg-cover" style="background-image: url('addons/img/blog2.jpg')"></div>
                        <div class="content">
                            <div class="post-author">
                ...
                <div class="col-xl-4 col-md-6 col-12">
                    <div class="single-blog-card">
                        <div class="blog-featured-thumb bg-cover" style="background-image: url('addons/img/blog3.jpg')"></div>
                        <div class="content">
                            <div class="post-author">
                                <a href="news-details.html"><i class="fal fa-user-circle"></i> Michael K. Steven</a>
                            </div>
    ...
    <section class="cta-banner">
        <div class="container-fluid bg-cover section-bg" style="background-image: url('addons/img/cta_bg1.png')">
                        ...
                        <div class="single-footer-wid recent_post_widget">
                            ...
                            <div class="recent-post-list">
                                <div class="single-recent-post">
                                    <div class="thumb bg-cover" style="background-image: url('addons/img/blog/b1.jpg');"></div>
                                    <div class="post-data">
                                ...
                                <div class="single-recent-post">
                                    <div class="thumb bg-cover" style="background-image: url('addons/img/blog/b2.jpg');"></div>
                                    <div class="post-data">
    ...
    <script src="addons/js/modernizr.min.js"></script>
    <script src="addons/js/jquery.easing.js"></script>
    <script src="addons/js/popper.min.js"></script>
    <script src="addons/js/bootstrap.min.js"></script>
    <script src="addons/js/isotope.pkgd.min.js"></script>
    <script src="addons/js/imageload.min.js"></script>
    <script src="addons/js/scrollUp.min.js"></script>
    <script src="addons/js/owl.carousel.min.js"></script>
    <script src="addons/js/magnific-popup.min.js"></script>
    <script src="addons/js/waypoint.js"></script>
    <script src="addons/js/easypiechart.min.js"></script>
    <script src="addons/js/counterup.min.js"></script>
    <script src="addons/js/wow.min.js"></script>
    <script src="addons/js/metismenu.js"></script>
    <script src="addons/js/timeline.min.js"></script>
    <script src="addons/js/ajax-mail.js"></script>
    <script src="addons/js/active.js"></script>
</body>
