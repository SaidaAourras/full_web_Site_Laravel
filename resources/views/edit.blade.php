...
<form method="POST" action="categorys/{$category}" enctype="multipart/form-data">
    @csrf
    <div class="mb-6">
        <label for="name" class="inline-block text-lg mb-2">Company Name</label>
        <input type="text"  value="{{ $category['name'] }}" class="border border-gray-200 rounded p-2 w-full" name="name" />
